...
fh = netcdf.Dataset(directory+'CESM_0600_RCP85/Ocean/Buoyancy_40-65N_'+str(depth_min)+'-'+str(depth_max)+'m.nc', 'r')
...
ax.set_title(r'f) Surface buoyancy flux, Hist/RCP8.5 and $\overline{F_H} = 0.18$ Sv')
...
ax.set_title(r'j) Upper 1,000 m ocean buoyancy, Hist/RCP8.5 and $\overline{F_H} = 0.18$ Sv')
