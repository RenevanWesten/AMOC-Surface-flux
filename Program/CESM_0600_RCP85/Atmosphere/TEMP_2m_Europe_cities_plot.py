...
fh = netcdf.Dataset(directory+'CESM_0600_RCP85/Atmosphere/TEMP_2m_Europe_locations.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_RCP85/Atmosphere/TEMP_2m_global.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_RCP85/Atmosphere/TEMP_2m_trend_year_2000-2100.nc', 'r')
...
ax.set_title('f) Temperature anomalies, Hist/RCP8.5 and $\overline{F_H} = 0.18$ Sv')
...
ax.set_title('b) Temperature trend, Hist/RCP8.5 and $\overline{F_H} = 0.18$ Sv')
