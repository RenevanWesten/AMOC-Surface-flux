#Program plots the precipitation responses
...
fh 	= netcdf.Dataset(directory+'CESM_0600_RCP85/Atmosphere/PREC_EVAP_year_1850-1899.nc', 'r')
...
fh 	= netcdf.Dataset(directory+'CESM_0600_RCP85/Atmosphere/PREC_EVAP_year_2450-2499.nc', 'r')
...
cbar.set_label('Precipitation anomaly (mm day$^{-1}$)')
...
ax.set_title('f) Precipitation, Hist/RCP8.5 and $\overline{F_H} = 0.18$ Sv')
