...
fh = netcdf.Dataset(directory+'CESM_1500_RCP85/Ocean/Buoyancy_surface_flux_40-65N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP85/Ice/Sea_ice_area_40N-65N.nc', 'r')
...
ax.set_title('d) Surface buoyancy freshwater fluxes, Hist/RCP8.5 and $\overline{F_H} = 0.45$ Sv')
...
ax.set_title('h) Surface buoyancy freshwater fluxes, Hist/RCP8.5 and $\overline{F_H} = 0.45$ Sv')
