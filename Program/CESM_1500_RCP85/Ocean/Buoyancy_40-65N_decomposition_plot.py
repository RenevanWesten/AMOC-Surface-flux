...
fh = netcdf.Dataset(directory+'CESM_1500_RCP85/Ocean/Buoyancy_40-65N_'+str(depth_min)+'-'+str(depth_max)+'m.nc', 'r')
...
ax.set_title(r'h) Surface buoyancy flux, Hist/RCP8.5 and $\overline{F_H} = 0.45$ Sv')
...
ax.set_title(r'l) Upper 1,000 m ocean buoyancy, Hist/RCP8.5 and $\overline{F_H} = 0.45$ Sv')
