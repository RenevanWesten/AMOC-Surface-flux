...
fh = netcdf.Dataset(directory+'CESM_1500_RCP85/Ocean/AMOC_density_coordinates_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP85/Ocean/WMT_latitude_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP85/Ocean/WMT_latitude_65N.nc', 'r')
...
ax.set_title(r'd) $\Psi_{\mathrm{NADW}}$, Hist/RCP8.5 and $\overline{F_H} = 0.45$ Sv')
