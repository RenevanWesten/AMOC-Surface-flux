...
fh 	= netcdf.Dataset(directory+'CESM_1500_RCP85/Atmosphere/TEMP_2m_year_1850-1899.nc', 'r')
...
fh 	= netcdf.Dataset(directory+'CESM_1500_RCP85/Atmosphere/TEMP_2m_year_2450-2499.nc', 'r')
...
ax.set_title('d) 2-meter temperature, Hist/RCP8.5 and $\overline{F_H} = 0.45$ Sv')
