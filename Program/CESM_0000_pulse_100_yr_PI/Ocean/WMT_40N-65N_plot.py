...
fh = netcdf.Dataset(directory+'CESM_0000_pulse_100_yr_PI/Ocean/AMOC_density_coordinates_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0000_pulse_100_yr_PI/Ocean/WMT_latitude_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0000_pulse_100_yr_PI/Ocean/WMT_latitude_65N.nc', 'r')
...
ax.set_title(r'c) $\Psi_{\mathrm{NADW}}$, $F_H = 0.00 \rightarrow 0.30 \rightarrow 0.00$ Sv')
