...
fh = netcdf.Dataset(directory+'CESM_0000_pulse_100_yr_PI/Ocean/Buoyancy_40-65N_'+str(depth_min)+'-'+str(depth_max)+'m.nc', 'r')
...
ax.set_title(r'f) Surface buoyancy flux, $F_H = 0.00 \rightarrow 0.30 \rightarrow 0.00$ Sv')
...
ax.set_title(r'a) Upper 1,000 m ocean buoyancy, $F_H = 0.00 \rightarrow 0.30 \rightarrow 0.00$ Sv')
