#Program plots the near-surface (2-meter) temperature responses
...
fh 	= netcdf.Dataset(directory+'CESM_0600_RCP45/Atmosphere/TEMP_2m_year_1850-1899.nc', 'r')
...
fh 	= netcdf.Dataset(directory+'CESM_0600_RCP45/Atmosphere/TEMP_2m_year_2450-2499.nc', 'r')
...
ax.set_title('a) 2-meter temperature, Hist/RCP4.5 and $\overline{F_H} = 0.18$ Sv')
