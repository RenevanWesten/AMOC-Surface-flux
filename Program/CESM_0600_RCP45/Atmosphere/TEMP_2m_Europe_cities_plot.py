...
fh = netcdf.Dataset(directory+'CESM_0600_RCP45/Atmosphere/TEMP_2m_Europe_locations.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_RCP45/Atmosphere/TEMP_2m_global.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_RCP45/Atmosphere/TEMP_2m_trend_year_2000-2100.nc', 'r')

lon		        = fh.variables['lon'][1:-1]
lat		        = fh.variables['lat'][1:-1] 			
temp_trend	    = fh.variables['TEMP_trend'][1:-1, 1:-1] 
temp_trend_sig	= fh.variables['TEMP_trend_sig'][1:-1, 1:-1]
...
ax.set_title('e) Temperature anomalies, Hist/RCP4.5 and $\overline{F_H} = 0.18$ Sv')
...
ax.set_title('a) Temperature trend, Hist/RCP4.5 and $\overline{F_H} = 0.18$ Sv')
