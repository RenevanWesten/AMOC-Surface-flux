...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_200_yr_PI/Ocean/Buoyancy_40-65N_'+str(depth_min)+'-'+str(depth_max)+'m.nc', 'r')
...
ax.set_title(r'f) Surface buoyancy flux, $F_H = 0.18 \rightarrow 0.48$ (200 yr)$ \rightarrow 0.18$ Sv')
...
ax.fill_between([-1, 200], -5, 40, alpha=0.25, edgecolor='orange', facecolor='orange')
...
ax.set_title(r'h) Upper 1,000 m ocean buoyancy, $F_H = 0.18 \rightarrow 0.48$ (200 yr)$ \rightarrow 0.18$ Sv')
