...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_200_yr_PI/Ocean/AMOC_density_coordinates_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_200_yr_PI/Ocean/WMT_latitude_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_200_yr_PI/Ocean/WMT_latitude_65N.nc', 'r')
...
ax.fill_between([-1, 200], -5, 30, alpha=0.25, edgecolor='orange', facecolor='orange')
...
ax2 		= fig.add_axes([0.50, 0.40, 0.37, 0.18])

ax2.fill_between([-1, 200], -5, 30, alpha=0.25, edgecolor='orange', facecolor='orange')
ax2.plot(time, dens_psi_max, '-', color = 'firebrick', linewidth = 1)

ax2.set_xlim(1, 300)
ax2.set_ylim(37.5, 36)
ax2.set_xticks([1, 100, 200, 300])
ax2.grid()
ax2.set_title('$\sigma_2^{\mathrm{max}}$ at 40$^{\circ}$N (kg m$^{-3}$)', fontsize = 10)

ax.set_title(r'd) $\Psi_{\mathrm{NADW}}$, $F_H = 0.18 \rightarrow 0.48$ (200 yr)$ \rightarrow 0.18$ Sv')
