...
fh 	= netcdf.Dataset(directory+'CESM_1500_RCP45/Atmosphere/PREC_EVAP_year_1850-1899.nc', 'r')
...
fh 	= netcdf.Dataset(directory+'CESM_1500_RCP45/Atmosphere/PREC_EVAP_year_2450-2499.nc', 'r')
...
ax.set_title('g) Precipitation, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
