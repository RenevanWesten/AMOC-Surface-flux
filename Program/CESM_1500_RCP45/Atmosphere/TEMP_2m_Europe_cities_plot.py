...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Atmosphere/TEMP_2m_Europe_locations.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Atmosphere/TEMP_2m_global.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Atmosphere/TEMP_2m_trend_year_2000-2100.nc', 'r')
...
ax.set_title('g) Temperature anomalies, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
...
ax.set_title('c) Temperature trend, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
