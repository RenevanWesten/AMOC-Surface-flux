...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Ocean/AMOC_density_coordinates_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Ocean/WMT_latitude_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Ocean/WMT_latitude_65N.nc', 'r')
...
ax.set_title(r'c) $\Psi_{\mathrm{NADW}}$, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
