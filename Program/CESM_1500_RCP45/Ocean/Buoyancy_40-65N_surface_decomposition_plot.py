...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Ocean/Buoyancy_surface_flux_40-65N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Ice/Sea_ice_area_40N-65N.nc', 'r')
...
ax.set_title('c) Surface buoyancy freshwater fluxes, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
...
ax.set_title('g) Surface buoyancy freshwater fluxes, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
