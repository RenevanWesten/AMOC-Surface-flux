...
fh = netcdf.Dataset(directory+'CESM_1500_RCP45/Ocean/Buoyancy_40-65N_'+str(depth_min)+'-'+str(depth_max)+'m.nc', 'r')
...
ax.set_title(r'g) Surface buoyancy flux, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
...
ax.set_title(r'k) Upper 1,000 m ocean buoyancy, Hist/RCP4.5 and $\overline{F_H} = 0.45$ Sv')
