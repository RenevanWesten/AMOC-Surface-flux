...
time_year	= time_year * 0.0003

#-----------------------------------------------------------------------------------------

fh = netcdf.Dataset(directory+'CESM_QE_PI/Ice/Sea_ice_area_40N-65N.nc', 'r')
...
ax1.set_title('a) Surface buoyancy flux (40$^{\circ}$N - 65$^{\circ}$N) climatology, heat fluxes')
...
ax1.set_title('b) Surface buoyancy flux (40$^{\circ}$N - 65$^{\circ}$N) climatology, freshwater fluxes')
...
graph_1	= ax.plot(time_year, buoyancy_temp_year, '-', linewidth = 1.5, color = 'k', label = '$B_{\mathrm{surf}}^T$ (total)')
...
ax.set_title('c) Surface buoyancy flux (40$^{\circ}$N - 65$^{\circ}$N), heat fluxes')
...
ax.set_title('d) Surface buoyancy flux (40$^{\circ}$N - 65$^{\circ}$N), freshwater fluxes')
