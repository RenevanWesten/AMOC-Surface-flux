...
fh = netcdf.Dataset(directory+'CESM_1600_pulse_100_yr_PI/Ocean/AMOC_density_coordinates_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1600_pulse_100_yr_PI/Ocean/WMT_latitude_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_1600_pulse_100_yr_PI/Ocean/WMT_latitude_65N.nc', 'r')
...
ax.set_title(r'e) $\Psi_{\mathrm{NADW}}$, $F_H = 0.48 \rightarrow 0.78 \rightarrow 0.48$ Sv')
