...
fh = netcdf.Dataset(directory+'CESM_1600_pulse_100_yr_PI/Ocean/Buoyancy_40-65N_'+str(depth_min)+'-'+str(depth_max)+'m.nc', 'r')
...
ax.set_title(r'h) Surface buoyancy flux, $F_H = 0.48 \rightarrow 0.78 \rightarrow 0.48$ Sv')
...
ax.set_title(r'c) Upper 1,000 m ocean buoyancy, $F_H = 0.48 \rightarrow 0.78 \rightarrow 0.48$ Sv')
