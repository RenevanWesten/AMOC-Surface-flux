...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_100_yr_PI/Ocean/Buoyancy_40-65N_'+str(depth_min)+'-'+str(depth_max)+'m.nc', 'r')
...
ax.set_title(r'g) Surface buoyancy flux, $F_H = 0.18 \rightarrow 0.48 \rightarrow 0.18$ Sv')
...
ax.set_title(r'b) Upper 1,000 m ocean buoyancy, $F_H = 0.18 \rightarrow 0.48 \rightarrow 0.18$ Sv')
