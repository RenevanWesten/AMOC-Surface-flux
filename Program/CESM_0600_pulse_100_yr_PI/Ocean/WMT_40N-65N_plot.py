...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_100_yr_PI/Ocean/AMOC_density_coordinates_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_100_yr_PI/Ocean/WMT_latitude_40N.nc', 'r')
...
fh = netcdf.Dataset(directory+'CESM_0600_pulse_100_yr_PI/Ocean/WMT_latitude_65N.nc', 'r')
...
ax2 		= fig.add_axes([0.21, 0.62, 0.37, 0.18])
...
ax.set_title(r'd) $\Psi_{\mathrm{NADW}}$, $F_H = 0.18 \rightarrow 0.48 \rightarrow 0.18$ Sv')
